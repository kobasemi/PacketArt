    ...
    public void handlePacket(PcapPacket pkt) {
        ...
        try {
            ...
            if (pkt.hasHeader(JProtocol.TCP_ID)) {
                PlaySE.getInstance().play(PlaySE.RDFSE1);//TEST
                ...
                PlaySE.getInstance().play(PlaySE.RDFSE2);//TEST
            ...
            //一般に、ICMPの上にTCPやUDPが来ることは少ないのでここで処理。
                ...
                PlaySE.getInstance().play(PlaySE.RDFSE3);//TEST
                ...
                PlaySE.getInstance().play(PlaySE.RDFSE4);//TEST
