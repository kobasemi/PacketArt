...
udo apt-get install openjdk-6-source; 
...
get http://downloads.sourceforge.net/project/jnetpcap/jnetpcap/1.3/jnetpcap-1.3.0-1.fc.i386.tgz; 
tar xzvf jnetpcap-1.3.0-1.fc.i386.tgz; 
cd jnetpcap-1.3.0; 
sudo cp libjnetpcap.so /usr/lib/; 
sudo chmod 644 /usr/lib/libjnetpcap.so; 
sudo cp ./include/*.h /usr/include/;#/usr/local/include 
